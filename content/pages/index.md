...
sections:
  ...
  - section_id: lorem-ipsum
    ...
    content: >
      SERUMS will be airdropped for free to the TIPSYTIGER CLUB members that
      hold the TipsyTiger NFT for more than 7 days after the public sale.


      Each airdropped serum can be used to combine two TipsyTiger NFT to breed a
      BRAND NEW and RARER TipsyTiger.


      And if you mint and own the first 2000 TipsyTigers NFT, you get a chance
      the win a special 1/1 ultra-rare  NFT & a free TESLA home.
    actions: []
    image_alt: lorem-ipsum
  ...
  - type: features_section
    ...
    features:
      - title: 0% - Welcome to TipsyTiger Club
        content: >
          Join our discord and become a TipsyTiger VIP member. VIP members mint
          at a discounted price, gain early access to sales, and many more. When
          we achieve 10,000 members in our Discord server, we will do AMAs with
          community members and drop more details about our TipsyTiger Hard
          Seltzer. We will also have up to $10,000 worth of giveaways for our
          discord members.
        actions: []
        image_alt: lorem-ipsum
        media_position: left
